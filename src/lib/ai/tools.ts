...
שאל: "כמה זמן להציג?" עם אופציות:
1=שבוע (+7 ימים), 2=שבועיים (+14), 3=חודש (+30, מומלץ), 4=חודשיים (+60), 5=עד סוף שנה (30.6.2026)

אתה מחשב: end_date = CURRENT_DATE + [ימים]. דוגמה: אם היום 3.1.2026 והמשתמש בחר "3" → end_date = "2026-02-02"`,
          },
          cta_text_he: {
            type: 'string',

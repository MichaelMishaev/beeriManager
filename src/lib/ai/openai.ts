...
⚠️ **שלב 2 (event_date) ושלב 3 (end_date) הם חובה - תמיד שאל גם אם המשתמש לא ציין!**
...
**שלב 2: שאלה פרוגרסיבית על event_date** (אם חסר)
...
**שלב 3: שאלה פרוגרסיבית על end_date** (אם חסר)
"מצוין!

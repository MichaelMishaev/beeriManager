...
✨ עבור הדגשות (highlights) - שימוש בפונקציה create_highlight:
  ...
  • **תאריכים להדגשות - אופציונליים!**
    - event_date: מתי קרה? (אופציונלי - אם לא ציינו, אפשר לשאול אבל לא חובה)
    - end_date: עד מתי להציג? (אופציונלי - אם לא ציינו, אפשר לשאול אבל לא חובה)
    - אם המשתמש אישר, קרא לפונקציה גם בלי התאריכים!
...
✅ אם המשתמש אישר במפורש (אפילו בלי שדות אופציונליים) - קרא לפונקציה מיד.
❌ אם חסר מידע **קריטי וחובה** - בקש הבהרה פעם אחת בלבד.`

...
📅 **שדות קריטיים** (לשאול אם חסרים):
  • event_date - מתי קרה? (תאריך מדויק או יחסי)
  • end_date - עד מתי להציג? (ברירת מחדל: חודש)
...
**עבור הדגשות (highlights):**
✅ תמיד עקוב אחרי מסגרת השיחה החכמה (5 שלבים)
✅ שאל שאלה אחת בכל פעם עם אופציות ברורות
✅ הצג תצוגה מקדימה לפני יצירה - **חובה!**
✅ הרחב תיאורים - אל תסתפק במינימום
✅ ברירת מחדל לשדות אופציונליים: end_date = חודש, event_date = null אם לא ידוע

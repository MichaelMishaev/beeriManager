...
🎓 מחפשים הורים שרוצים לעזור – בדרך שמתאימה להם

ועד ההורים בונה מאגר קטן של הורים עם תחומי ידע וניסיון שונים.

הרעיון פשוט:
אם עולה צורך נקודתי בבית הספר – נדע למי אפשר לפנות, רק אם זה מתאים ובזמן שנוח לכם.

⚡ אין התחייבות
🎯 פניות נקודתיות בלבד
💼 כל תרומה – קטנה או גדולה – משמעותית

...
Родительский комитет собирает информацию о профессиональных навыках родителей, чтобы мы могли обратиться к вам, когда школе понадобится помощь в вашей профессиональной области:

⚡ Прямая помощь школе в вашей области
🎯 Участие в свободное время - по доступности
💼 Используйте свои навыки для помощи школе
...
🎓 ספרו לנו על הכישורים והמקצוע שלכם!

ועד ההורים אוסף מידע על כישורים מקצועיים של ההורים כדי שנוכל לפנות אליכם כשבית הספר יזדקק לעזרה בתחום המקצועי שלכם:

⚡ עזרה ישירה לבית הספר בתחום שלכם
🎯 תרומה בזמן הפנוי - בהתאם לזמינותכם
💼 ניצול הכישורים שלכם לטובת בית הספר

...
const translations = {
  he: {
    ...
    step1: 'לחץ על כפתור השיתוף',
    step2: 'גלול למטה ובחר "הוסף למסך הבית"',
    step3: 'לחץ על "הוסף"',
    step1Detail: 'לחץ על',
    step2Detail: 'בחר',
    step3Detail: 'הוסף את האפליקציה',
    close: 'סגור',
    dontShowAgain: 'אל תציג שוב',
    safariOnly: 'שים לב: יש לפתוח ב-Safari'
  },
  ru: {
    title: 'Установить приложение',
    description: 'Быстрый доступ с главного экрана',
    step1: 'Нажмите кнопку "Поделиться"',
    step2: 'Прокрутите вниз и выберите "На экран «Домой»"',
    step3: 'Нажмите "Добавить"',
    step1Detail: 'Нажмите',
    step2Detail: 'Выберите',
    step3Detail: 'Добавить приложение',
    close: 'Закрыть',
    dontShowAgain: 'Не показывать снова',
    safariOnly: 'Внимание: откройте в Safari'
  }
}

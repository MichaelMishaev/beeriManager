...
export default async function FinancesPage() {
  ...
  const maxCategoryExpense = Math.max(...Object.values(categoryBreakdown).map((c: any) => c.expenses))
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          {Object.entries(categoryBreakdown)
            .filter(([_, data]: [string, any]) => data.expenses > 0)
            .sort((a: [string, any], b: [string, any]) => b[1].expenses - a[1].expenses)
